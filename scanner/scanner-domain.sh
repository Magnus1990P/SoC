...
############################
##	NUCLEI SCAN
NUCLEI_REPORTING_TEMPLATE="./nuclei-reporting.yaml"
NUCLEI_OUTPUTFILE="./OUTPUT-nuclei.jsonl"
./nuclei -rc "$NUCLEI_REPORTING_TEMPLATE" \
	-as -sa -dr -project -r "$TF_DNS" -c 50 -timeout 3 \
	-j -o "$NUCLEI_OUTPUTFILE" \
	-l "$TF_NUCLEI"
